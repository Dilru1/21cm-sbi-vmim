...
def main():
    ...
    fig.suptitle("Noise smear at fixed theta (stars = per-sim means). "
                 "Wider clouds -> wider posteriors.", y=1.0)
    ...
    if len(arms) == 2:
        ...
        print("  (<1 = information lost at the higher noise level; the parameter whose\n"
