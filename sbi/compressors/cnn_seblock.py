...
class ResNet3DCompressor(nn.Module):
    def __init__(self, t_dim=8, n_params=4, direct=False):
        ...
        self.conv1 = DepthwiseSeparableConv3d(3, 32, 3, 2, 1); self.bn1 = nn.GroupNorm(4, 32); self.se1 = SEBlock3d(32, 4)
        self.conv2 = DepthwiseSeparableConv3d(32, 64, 3, 2, 1); self.bn2 = nn.GroupNorm(8, 64); self.se2 = SEBlock3d(64, 8)
        self.conv3 = DepthwiseSeparableConv3d(64, 128, 3, 2, 1); self.bn3 = nn.GroupNorm(8, 128); self.se3 = SEBlock3d(128)
        self.conv4 = DepthwiseSeparableConv3d(128, 256, 3, 2, 1); self.bn4 = nn.GroupNorm(8, 256); self.se4 = SEBlock3d(256)
        self.conv5 = nn.Conv3d(256, 512, kernel_size=2, stride=1, padding=0); self.bn5 = nn.GroupNorm(8, 512)
